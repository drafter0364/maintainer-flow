import type { AnalysisResult, Finding, RiskLevel } from "./types.js";

const riskPrefix: Record<RiskLevel, string> = {
  low: "[LOW]",
  medium: "[MEDIUM]",
  high: "[HIGH]"
};
...
export function resultToMarkdown(result: AnalysisResult): string {
  ...
  lines.push(
    ...
    "### Maintainer note",
    "",
    "This report is advisory. Maintainers should treat issue text, pull request content, and generated summaries as untrusted input."
  );
